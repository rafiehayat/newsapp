  ...
  async getApiData() {
    ...
    if (this.props.search)
      response = await fetch(
        ...
        &apiKey=5b3a668a88c64945a907d7a4ce0ce042`
      );
    else
      response = await fetch(
        `https://newsapi.org/v2/everything?q=${this.props.q}&pageSize=12&page=${this.state.page}&sortBy=publishedAt&language=${this.props.language}&apiKey=5b3a668a88c64945a907d7a4ce0ce042`
      );
